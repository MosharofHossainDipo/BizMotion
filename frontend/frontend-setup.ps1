...
'@ | Set-Content "$src\models\auth.model.ts" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\services\auth.service.ts" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\interceptors\jwt.interceptor.ts" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\guards\auth.guard.ts" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\guards\role.guard.ts" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\auth\login\login.component.html" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\auth\login\login.component.css" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\auth\login\login.component.ts" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\auth\register\register.component.html" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\auth\register\register.component.css" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\auth\register\register.component.ts" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\dashboard\admin\admin-dashboard.component.ts" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\dashboard\user\user-dashboard.component.ts" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\app.routes.ts" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\app.config.ts" -Encoding UTF8NoBOM
...
'@ | Set-Content "$src\app.component.ts" -Encoding UTF8NoBOM
...
'@ | Set-Content "src\styles.css" -Encoding UTF8NoBOM
